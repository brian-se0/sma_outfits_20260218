...
def test_build_paper_hardening_init_payload_exposes_known_capabilities(settings) -> None:
    ...
    assert capabilities["reconciliation_enabled"] is False
    ...
    assert "reconciliation_disabled" in ids
